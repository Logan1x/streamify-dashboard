      ...
      <ErrorBoundary>
        <Suspense fallback={<div>Loading...</div>}>
          <div className="grid grid-cols-1 lg:grid-cols-2 xl:grid-cols-3 gap-8">
            <div className="col-span-1 lg:col-span-2 xl:col-span-3 bg-white p-6 rounded-lg shadow-md">
            ...
            <div className="col-span-1 lg:col-span-2 xl:col-span-2 bg-white p-6 rounded-lg shadow-md">
              <TopStreamedSongs />
            </div>
